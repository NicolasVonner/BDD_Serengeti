...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="page_interventions.html">Group interventions</a></li>
  ...
  <h1>Page d'intervention</h1>
  <p>Ici nous renseignons les interventions effectués, les equipes concernés ... </p>

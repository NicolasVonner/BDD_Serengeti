<?php
    ...
    $vaccin=strip_tags(htmlspecialchars($_POST['vaccin']));

    $req='INSERT INTO ANIMAL("classeA", "familleA","especeA", "sexeA", "dateArrivee",vaccin) values (?, ?, ?,?,?,?)';  
    ...
    $statement->bindParam(4,$dateArrivee,PDO::PARAM_STR);
    $statement->bindParam(5,$vaccin,PDO::PARAM_STR);
    $statement->execute();
    
    echo '<script language="Javascript">
    document.location.replace("http://localhost:8000/pages/animales.php");
    </script>';  
?>
